...
import { lerp, getMousePos, calcWinsize, distance } from '../utils/index.js';
...
export default class ButtonCtrl extends EventEmitter {
    constructor(el) {
        ...
        this.DOM = { el: el };
        this.DOM.text = this.DOM.el.querySelector('.company__button__text');
        this.DOM.textinner = this.DOM.el.querySelector('.company__button__text-inner');
